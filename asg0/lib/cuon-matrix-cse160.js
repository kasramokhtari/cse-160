...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        let v1 = other1.elements[0] * other2.elements[0]
        let v2 = other1.elements[1] * other2.elements[1]
        let v3 = other1.elements[2] * other2.elements[2]
        let d = v1 + v2 + v3
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([v0, v1, v2]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        // Insert your code here.
        let v1 = this.elements[0] * this.elements[0];
        let v2 = this.elements[1] * this.elements[1];
        let v3 = this.elements[2] * this.elements[2];
        // Don't delete the return statement.
